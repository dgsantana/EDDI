...
namespace EddiSpeechService
{
    ...
    public class Translations
    {
        ...
        {
            { "Achenar", new[] { "ˈakɜːnɑ" } },
            { "Acihault", new[] { "əˈsɪhɔːt" } },
            { "Adan", new[] { "ˈædən" } },
            { "Alcyone", new[] { "ælˈsaɪəniː" } },
            { "Aldebaran", new[] { "alˈdɛbəɹən" } },
            { "Anemoi", new[] { "æˈniːmɔɪ" } },
            { "Apoyota", new[] { "æˈpɔɪəʊtə" } },
            { "Arque", new[] { "ɑːrk" } },
            { "Asterope", new[] { "əˈstɛroʊpiː" } },
            { "Atlas", new[] {  "ˈætləs" } },
            { "Aulin", new[] { "ˈɔːlɪn" } },
            { "Bunda", new[] { "ˈbuːndə" } },
            { "Cayutorme", new[] { "ˈkaɪətɔːm" }  },
            { "Celaeno", new[] {  "sᵻˈliːnoʊ" }  },
            { "Ceos", new[] { "ˈkeɪɒs" }  },
            { "Cygnus", new[] { "ˈsɪɡnəs" }  },
            { "Deciat", new[] { "ˈdɛsiːæt" } },
            { "Diso ", new[] { "ˈdiːsəʊ" } },
            { "Djiwal", new[] { "ˈdʒɪwæl" } },
            { "Dvorsi", new[] { "ˈdvɔːsiː" } },
            { "Electra", new[] { "ᵻˈlɛktrə" } },
            { "Eravate" , new[] { "ɛrəˈvɑːtˌeɪ" } },
            { "Eranin" , new[] { "ˈɛrənin" } },
            { "Frigaha", new[] { "frɪɡˈɑːhɑːr" } },
            { "Grandmort" , new[] { "ˈɡʀɒdˌmɔʀ" } },
            { "Hecate" , new[] { "ˈhɛkətɪ" } },
            { "Hotas" , new[] { "həʊtæs" } },
            { "Isleta" , new[] { "aɪlˈetə" } },
            { "i Bootis" , new[] { "aɪ", "bəʊˈəʊtɪs" } },
            { "Lave", new[] { "leɪv" } },
            { "Kaia Bajaja", new[] { "ˈkaɪə", "ˈbɑːhɑːhɑː" } },
            { "Kigana", new[] { "kiːˈɡɑːnə" } },
            { "Kini", new[] { "ˈkiːniː" } },
            { "Kremainn", new[] { "krəˈmeɪn" } },
            { "Laksak", new[] { "ˈlæks.æk" } },
            { "Leesti", new[] { "ˈliːstiː" } },
            { "Leucos", new[] { "ˈluːkɒs" } },
            { "Luyten's Star", new[] { "ˈlaʊ.təns", "stɑː" } },
            { "Maia", new[] { "ˈmaɪ.ə" } },
            { "Mata", new[] { "ˈmɑː.tʌ" } },
            { "Merope", new[] { "ˈmɛrəpiː" } },
            { "Mu Koji", new[] { "mjuː", "ˈkəʊdʒiː" } },
            { "Nuenets", new[] { "ˈnjuːənɛts" } },
            { "Okinura", new[] { "ɒkɪˈnjʊrə" } },
            { "Orrere", new[] { "ɒrˈɪər" } },
            { "Pai Szu", new[] { "paɪ", "ʃuː" } },
            { "Pleione", new[] { "ˈplaɪəniː" } },
            { "Procyon", new[] { "ˈprəʊˌsɪən" } },
            { "Potriti", new[] { "pəˈtriːtɪ" } },
            { "Reorte", new[] { "ˌriːˈɔːt" } },
            { "Sakti", new[] { "ˈsæk.tiː" } },
            { "Shinrarta Dezhra", new[] { "ʃɪnˈrɑːrtə", "ˈdezɦrə" } },
            { "Surya", new[] { "ˈsuːˈrɪːˈɛr" } },
            { "Taygeta", new[] { "teɪˈɪdʒᵻtə" } },
            { "Tse", new[] { "ʃjɛ" } },
            { "Xihe", new[] { "ʃiː.hər" } },
            { "Xinca", new[] { "ˈʃɛnkə" } },
            { "Yakabugai", new[] { "ˈjækəbuːɡaɪ" } },
            { "Zaonce", new[] { "ˈzeɪɒns" } },
            { "Zhang Fei", new[] { "ʈʂáŋ", "feɪ" } },
        };

        private static Dictionary<string, string[]> CONSTELLATION_PRONUNCIATIONS = new Dictionary<string, string[]>()
        {
            { "Alrai" , new[] { "ˈalraɪ" } },
            { "Antliae" , new[] { "ˈæntlɪˌiː" } },
            { "Aquarii" , new[] { "əˈkwɛərɪˌaɪ" } },
            { "Arietis" , new[] { "əˈraɪɪtɪs" } },
            { "Bei Dou" , new[] { "beɪ", "ˈduː" } },
            { "Blanco" , new[] { "blæŋkˌəʊ" } },
            { "Bleae Thaa" , new[] { "bliːiː", "θɑː" } },
            { "Bleae Thua" , new[] { "bliːiː", "θuːə" } },
            { "Capricorni" , new[] { "ˌkæprɪˈkɔːnaɪ" } },
            { "Cepheus" , new[] { "ˈsiːfjuːs" } },
            { "Cephei" , new[] { "ˈsiːfɪˌaɪ" } },
            { "Ceti" , new[] { "ˈsiːtaɪ" } },
            { "Chi Persei" , new[] { "kaɪ", "ˈpɜːsɪˌaɪ" } },
            { "Crucis" , new[] { "ˈkruːsɪs" } },
            { "Cygni" , new[] { "ˈsɪɡnaɪ" } },
            { "Eta Carina" , new[] { "ˈiːtə", "kəˈriːnə" } },
            { "Fornacis" , new[] { "fɔːˈneɪsɪs" } },
            { "Herculis" , new[] { "hɜːkjʊˈlɪs" } },
            { "Hyades" , new[] { "ˈhaɪəˌdiːz" } },
            { "Hydrae" , new[] { "ˈhaɪdriː" } },
            { "Lupus" , new[] { "ˈluːpəs" } },
            { "Lyncis" , new[] { "ˈlɪnsɪs" } },
            { "Omega" , new[] { "ˈəʊmɪɡə" } },
            { "Ophiuchus" , new[] { "ɒˈfjuːkəs" } },
            { "Pegasi" , new[] { "ˈpɛɡəˌsaɪ" } },
            { "Persei" , new[] { "ˈpɜːsɪˌaɪ" } },
            { "Piscium" , new[] { "ˈpaɪsɪəm" } },
            { "Pleiades" , new[] { "ˈplaɪədiːz" } },
            { "Puppis" , new[] { "ˈpʌpɪs" } },
            { "Pru Euq" , new[] { "pruː", "juːk"} },
            { "Rho Ophiuchi" , new[] { "rəʊ", "ɒˈfjuːkaɪ" } },
            { "Sagittarius", new[] { "ˌsædʒˈtɛəriəs" } },
            { "Scorpii", new[] { "ˈskɔːpɪˌaɪ" } },
            { "Shui Wei", new[] { "ˈʃuːi", "weɪ" } },
            { "Tau Ceti" , new[] { "taʊ", "ˈsiːtaɪ" } },
            { "Tascheter", new[] { "ˈtɑːʃətɜː" } },
            { "Trianguli", new[] { "traɪˈæŋˌɡjʊˌlaɪ" } },
            { "Trifid", new[] { "ˈtraɪfɪd" } },
            { "Tucanae", new[] { "tuːˈkɑːniː" } },
            { "Wredguia", new[] { "ˈredɡaɪə" } },
        };
